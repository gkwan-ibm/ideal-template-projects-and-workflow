...
(To be confirmed) Users will update the [hotspot=groudId file=0]`description`

(To be confirmed) The minimal set of [hotspot=featureManager file=0]`features` are: `jaxrs-2.1`, ...

> what should the minimal set of features be? +
> > Should include mpHealth-2.1?
